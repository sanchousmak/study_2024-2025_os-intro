...
Научиться оформлять отчёты с помощью легковесного языка разметки Markdown, изучить расширенные структуры и автоматизацию конвертации.
...
В ходе выполнения данной лабораторной работы я научилась оперативно и профессионально оформлять академические отчёты с помощью легковесного языка разметки Markdown, а также работать со структурированными сценариями для сборки кроссплатформенных документов.
